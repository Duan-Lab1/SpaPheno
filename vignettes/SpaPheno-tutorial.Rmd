---
title: "SpaPheno Tutorial: Linking Spatial Transcriptomics to Clinical Phenotypes with Interpretable Machine Learning"
package: "SpaPheno"
author:
  - name: Bin Duan
    affiliation: SJTU
...
Here are Key Features of **SpaPheno**:
...
# install.packages("SpaPheno_0.0.2.tar.gz", repos = NULL, type = "source")
...
>
>   → More suitable for **spatial transcriptomics**, which typically exhibits higher technical heterogeneity
>
> - **Higher values (e.g., 200)**
>
>   → Weaker normalization, assuming more stable detection sensitivity
>
>   → More suitable for **bulk RNA-seq**, where technical variation is relatively modest
>
...
```{r, echo=FALSE}
rm(list = ls())
load("/Users/hua/Documents/project/SpaPheno_R/data/raw/BRCAsurvival.RData")
```
...
```{r, echo=FALSE}
rm(list = ls())
load("/Users/hua/Documents/project/SpaPheno_R/data/raw/KIRC_survival.RData")
```
...
```{r, echo=FALSE}
rm(list = ls())
load("/Users/hua/Documents/project/SpaPheno_R/data/raw/HCC_stage.RData")
```
...
```{r, echo=FALSE}
rm(list = ls())
load("/Users/hua/Documents/project/SpaPheno_R/data/raw/Melanoma_ICB.RData")
```
